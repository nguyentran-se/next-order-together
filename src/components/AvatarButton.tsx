import Avatar from '@/app/_common/Avatar.component';
  ...
  return (
    <>
      ...
      >
        ...
        {profile && <Typography textAlign="center" component='div' pt={1}>Hi, <Typography fontWeight='500' component='span'>{profile.fullName}</Typography></Typography>}
        {profile && <Spacer />}
        {profile && <Divider />}
        {profile && (
          <MenuItem>
